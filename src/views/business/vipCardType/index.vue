<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="卡类型编码" prop="code">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['business:vipCardType:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['business:vipCardType:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['business:vipCardType:remove']"
        >删除</el-button>
      </el-col>
      <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <el-table v-loading="loading" :data="vipCardTypeList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="ID" align="center" prop="id" />
      <el-table-column label="卡类型编码" align="center" prop="code" />
      ...
      <el-table-column label="时长(月)" align="center" prop="months" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-form-item label="卡类型编码" prop="code">
          <el-input v-model="form.code" placeholder="请输入卡类型编码" />
        </el-form-item>
        <el-form-item label="卡类型名称" prop="name">
          <el-input v-model="form.name" placeholder="请输入卡类型名称" />
        </el-form-item>
        <el-form-item label="价格" prop="price">
          <el-input-number v-model="form.price" :precision="2" :step="0.01" :min="0" placeholder="请输入价格" />
        </el-form-item>
        <el-form-item label="时长(月)" prop="months">
          <el-input-number v-model="form.months" :min="1" placeholder="请输入时长(月)" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getVipCardType(id).then(response => {
